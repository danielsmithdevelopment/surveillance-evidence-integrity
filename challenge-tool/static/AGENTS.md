...
| POST | `/api/generate` | Generate FRE 901 / 702 / 4th Am / §1983 docs (`footageCategory`: fixed_surveillance \| body_worn \| cellphone; optional `bodyCamRecordingStatus`: missing \| partial \| recorded) |
