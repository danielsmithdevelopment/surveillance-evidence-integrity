...
const VENDORS = {
  flock: {
    ...
    accessAbuseFacts: [
      ...
      "ALPR cameras systematically log vehicles arriving at and departing from gun stores, gun shows, shooting ranges, and firearms training facilities. Texas Gun Rights President Chris McNutt stated: 'The government does not need your rifle's serial number if it can track every trip you make to the range, gun store, gun show, or gun-rights meeting. That is a gun-owner registry built from your movements instead of a Form 4473.' AmmoLand News / Texas Gun Rights, August 2026.",
      "Representative Tim Burchett (R-TN) introduced H.R. 9800 — the Protection Against Mass Surveillance Act — on July 21, 2026, which would ban federal agencies from purchasing, deploying, operating, accessing, or contracting for Flock Safety cameras and similar mass surveillance technologies. The bill was referred to the House Committee on Oversight and Government Reform.",
      "Flock Safety spent $920,000 on federal lobbying in 2025 and another $230,000 in the first quarter of 2026 alone. Motorola Solutions spent more than $2 million in the same period. This lobbying spend is relevant to understanding the political economy of ALPR oversight resistance. AmmoLand News, July 2026.",
      "Flock Safety's Alpha platform combines autonomous flight, aerial license plate recognition, thermal imaging, and live video with the company's existing police surveillance network, announced in 2026. AmmoLand News, August 2026.",
      "In April 2026, the ACLU filed an amicus brief in a Fourth Circuit case arguing that ALPR systems give the government unprecedented surveillance powers that upset traditional expectations of privacy in violation of the Fourth Amendment. In May 2026, the ACLU supported a bipartisan amendment to the federal highway funding bill that would have prevented cities and states from using ALPR cameras except for tolling purposes.",
    ],
    authFacts: [
    ...
    civilFacts: [
      ...
      "Where a person's plate was captured at a gun range, gun store, gun show, or firearms training facility, ALPR collection of that data without a warrant implicates the Second Amendment alongside the Fourth. Under NYSRPA v. Bruen, 597 U.S. 1 (2022), the government bears the burden of demonstrating that any regulation of Second Amendment activity is consistent with historical tradition. There is no historical tradition of warrantless mass surveillance of who visits gun stores or ranges. The collection of travel pattern data sufficient to identify gun owners through their lawful movements — without the statutory framework, oversight, or limitations that govern Form 4473 firearms transaction records — is a backdoor gun owner registry with no legal basis. Both Second Amendment and Fourth Amendment claims belong in the civil demand letter when the ALPR collection occurred at a gun-related location.",
    ...
    droneFacts: [
      ...
      "Flock Safety's Alpha platform combines autonomous flight, aerial license plate recognition, thermal imaging, and live video with the company's existing police surveillance network (AmmoLand News, August 2026). Aerial ALPR plus thermal payloads intensifies both Fourth Amendment curtilage concerns and Second Amendment concerns when flight paths cover gun ranges, gun stores, or gun shows.",
    ...
    sources: [
      ...
      "AmmoLand News — Burchett H.R. 9800 and gun owner tracking (July–August 2026)",
      "Texas Gun Rights — Form 4473 backdoor registry argument (August 2026)",
      "MRSC — Washington SB 6002 ALPR restrictions effective March 30, 2026",
      "ACLU Get the Flock Out campaign — Fourth Circuit amicus brief (April 2026)",
...
Where the user's plate was captured at a gun range, gun store, gun show, firearms training facility, or gun rights meeting, the civil demand letter must include a Second Amendment claim alongside the Fourth Amendment claim.

Under NYSRPA v. Bruen, 597 U.S. 1 (2022), the government bears the burden of demonstrating that any regulation of Second Amendment activity is consistent with the historical tradition of firearm regulation. There is no historical tradition of warrantless mass surveillance of who visits gun stores, ranges, or gun shows. ALPR collection at these locations creates what Texas Gun Rights has accurately described as "a gun-owner registry built from your movements instead of a Form 4473" — a backdoor identification system with none of the legal framework, oversight, or limitations governing Form 4473 firearms transaction records.

The Second Amendment argument applies with particular force when: (a) the user's plate was captured repeatedly at gun-related locations, creating a travel pattern sufficient to identify them as a gun owner; (b) the data was shared with or queried by federal agencies including ATF; or (c) the capture occurred at a private business like a gun range that did not consent to continued data collection (see Eagle Sports Range, Cudahy Wisconsin, August 2026 — Flock contractually forced continued collection against the business's wishes).

Discovery requests in Second Amendment cases: all ALPR queries run against plates captured at the specific gun-related location; all sharing of that location's ALPR data with federal agencies including ATF, DHS, and FBI; any categorization of frequent gun range visitors as higher-risk or of elevated law enforcement interest; and the contractual terms governing any private business's Flock installation at the location.

H.R. 9800 — the Protection Against Mass Surveillance Act — is pending before the House Committee on Oversight and Government Reform as of August 2026. Reference it in the civil demand letter as legislative acknowledgment of the constitutional problem.
...
3. Legal basis:
   ...
   - Second Amendment (include when facts fit): if the client's plate was captured at a gun range, gun store, gun show, firearms training facility, or gun-rights meeting without a warrant, plead a parallel § 1983 Second Amendment claim under NYSRPA v. Bruen, 597 U.S. 1 (2022). Frame ALPR collection at these locations as a "gun-owner registry built from your movements instead of a Form 4473" (Texas Gun Rights / Chris McNutt) — backdoor identification without the statutory framework governing Form 4473. Cite Eagle Sports Range (Cudahy, WI, 2026) when a private gun-related business did not consent to continued collection. Reference pending H.R. 9800 (Protection Against Mass Surveillance Act) as legislative acknowledgment. Demand discovery of: all queries against plates captured at that location; sharing with ATF/DHS/FBI; any "high-risk" categorization of frequent range visitors; and the private operator's Flock contract terms.
