...
const VENDORS = {
  flock: {
    ...
    accessAbuseFacts: [
      ...
      "The Washington Post published an investigation on August 19, 2026 — co-bylined by Douglas MacMillan, Aaron Schaffer, and Drew Harwell — finding that police departments are not regularly auditing how their officers use Flock's nationwide network. The Post used the same publicly available audit logs from HaveIBeenFlocked.com to identify officers running hundreds or thousands of searches on individual plates, then found personal connections between those officers and the searched plates using social media and public records. Within one day of the Post contacting a Haines City, Florida officer's wife, the officer confessed to his supervisor and was arrested — with the arrest affidavit specifically mentioning the reporter's outreach. Indianapolis Police Chief Tanya Terry suspended an officer without pay after being contacted and acknowledged the department had not been conducting regular audits. Washington Post, August 19, 2026.",
      "The Washington Post investigation establishes that journalists using publicly available Flock audit data were able to detect officer misconduct in days that police departments failed to detect over months or years despite having access to the same data. This is direct evidence that the audit tools Flock provides are sufficient to detect the documented abuse pattern — and that the failure was not technical but institutional. Departments chose not to conduct regular audits. This pattern of deliberate indifference to known risks of abuse from a known surveillance tool, combined with the existence of adequate detection tools that were not used, supports a Monell claim against agencies for policy-or-custom liability under 42 U.S.C. § 1983, in addition to individual officer liability.",
      "In the Milwaukee Officer Josue Ayala case, the alleged misuse was not discovered by internal audit. One of the victims searched her own license plate on HaveIBeenFlocked.com, found nearly 200 unauthorized searches, and then alerted police — which prompted the investigation that led to charges. The Milwaukee Police Department Chief of Staff stated: 'I think the assumption was the audit function that we had in place was being utilized, and we didn't really understand the gaps in that audit system until something slipped through the cracks.' FOX6 Milwaukee, 2026.",
      "Flock network audit logs obtained from Eugene, Oregon showed the search reason field contained entries including 'hehehe,' 'ICE,' 'Immigration,' and a search from Johnson County, Texas for a woman who 'had an abortion.' Medford, Oregon PD searched Eugene's cameras with 'hehehe' as the documented reason. These entries demonstrate that Flock's required reason field provides no meaningful accountability — any text is accepted regardless of legitimacy. Register-Guard / University of Washington Center for Human Rights, 2025-2026.",
    ...
    authFacts: [
      ...
      "Flock's current terms define 'Flock Property' to include 'any derivative works, intermediate or final outputs, analyses, reports, models, or other results generated by or through the Flock Services,' and state that customers have no right to download, extract, export, or retain copies of such derivative works. Section 4.1 grants Flock 'an irrevocable, perpetual, worldwide license to use Customer Data to support and improve Flock's products and services' — a right that survives contract termination. The previous terms stated flatly 'Flock does not own and shall not sell Customer Data.' That explicit prohibition is now absent from current Flock contracts. The ACLU of Georgia and Footnote4a legal analysis (February–May 2026) both concluded that the new structure grants Flock perpetual use rights over customer data while formal ownership remains nominal. Flock describes the changes as administrative cleanup. ACLU of Georgia / Footnote4a / haveibeenflocked.com, February–August 2026.",
      "HaveIBeenFlocked.com has reported that Flock provides customers access not to the original raw footage but to altered, degraded, low-resolution copies lacking metadata including timestamps. If confirmed, this is directly relevant to FRE 901 authentication: the footage produced in discovery would be a Flock-processed derivative copy, not the original camera output. Discovery requests should specifically demand the original unprocessed camera output and all metadata including timestamps, GPS coordinates, and camera calibration data — not merely the version Flock makes available through its Web Interface.",
      "Flock's current terms grant Flock 'the exclusive right to determine and control the method, timing, format, and medium' of customer access to data. This means even footage a customer nominally 'owns' can only be accessed through Flock's Web Interface in whatever format Flock chooses to provide. Oregon's 2026 Automated License Plate Recognition System Act explicitly overrides this contractual structure for Oregon customers, requiring that captured data 'may not be used by or licensed to Flock for any purpose inconsistent with customer policies' and mandating end-to-end encryption. The Oregon provision is the legislative model for closing the perpetual license gap.",
    ],
    civilFacts: [
      ...
      "The Washington Post's August 19, 2026 investigation establishes the Monell framework for agency liability in Flock abuse cases. A Monell claim under 42 U.S.C. § 1983 requires showing a municipal policy or custom caused the constitutional violation. The Post investigation documents that: (1) agencies had access to audit tools sufficient to detect abuse; (2) agencies chose not to conduct regular audits; (3) Indianapolis Police Chief Tanya Terry acknowledged the department had not been conducting regular audits even after publicly assuring residents that officer use was appropriate; (4) abuse was detected only when journalists or victims independently reviewed the same publicly available data departments had chosen not to examine. A department that publicly vouches for appropriate use while failing to audit for known risks of abuse from a documented pattern of misconduct has a deliberate indifference policy sufficient to support Monell liability.",
    ],
    droneFacts: [
    ...
    sources: [
      ...
      "Washington Post — MacMillan, Schaffer, Harwell: 'We found cops who misused Flock. Their police departments didn't know.' (August 19, 2026): washingtonpost.com/technology/2026/08/19/we-found-cops-who-misused-flock-their-police-departments-didnt-know/",
      "Register-Guard / UW Center for Human Rights — Eugene Oregon audit logs including 'hehehe' and abortion searches (2025-2026)",
      "Range Media / UW Center for Human Rights — Spokane County Flock surveillance series (November-December 2025)",
      ...
      "Footnote4a legal analysis — Flock February 2026 terms: 'The Deal Has Been Altered Further' (February 2026)",
      "ACLU of Georgia — municipalities beware Flock terms changes (May 2026)",
      "ACLU — Flock Terms & Conditions analysis (June 2026)",
      "HaveIBeenFlocked.com — degraded copy access reporting",
      "Oregon 2026 Automated License Plate Recognition System Act — state-specific Flock contract provisions",
    ],
  },
...
The Washington Post investigation published August 19, 2026, establishes the factual predicate for Monell agency liability in Flock abuse cases. Where a department: (1) publicly assured residents that officer use was appropriate and limited to legitimate law enforcement purposes; (2) had access to audit tools capable of detecting the abuse pattern documented in the IJ database; (3) chose not to conduct regular audits; and (4) failed to detect abuse that journalists identified in days using the same publicly available data — that department has exhibited deliberate indifference to a known risk of constitutional violations from a known surveillance tool. Deliberate indifference to known risks is the Monell standard for policy-or-custom liability. Include a Monell claim against the agency alongside the individual officer § 1983 claim in every civil demand letter where the department failed to conduct regular audits of officer Flock use.

Discovery requests for Monell claims: all records of audits conducted by the department of officer Flock use in the 24 months preceding the incident; any communications in which department leadership assessed or discussed the risk of officer misuse of Flock; any public statements by department leadership regarding appropriate use of Flock; records of any prior complaints or internal investigations involving officer Flock misuse at the department; and the department's written policy — if any — governing frequency and methodology of Flock audit reviews.
...
8. Specific discovery requests targeting ${vendorName}'s integrity controls (at least ten), and when Flock/Condor facts apply include: complete logs of all IP addresses and sessions that accessed the camera's administrative portal, live feed, or archived footage during the 30-day retention window preceding the incident; Flock's internal documentation of when the December 2025 open-internet misconfiguration began and when it was remediated for the specific camera; records of whether footage was accessed, downloaded, modified, or deleted by any party other than authorized agency personnel; camera model identification (Condor vs ALPR vs other). When ${vendorName} is Flock Safety, also include authentication-challenge-guide Request 13: original unprocessed camera output (not Web Interface version), all metadata to millisecond precision, processing steps between sensor capture and production, contractual terms §1.12/§1.13/§4.1 in effect at capture, and agency communications about litigation-format production
...
6. Monell municipal liability (include when facts fit): where the department had Flock audit tools, failed to conduct regular audits, publicly vouched for appropriate use, and abuse was detected only by journalists or victims using HaveIBeenFlocked.com data — plead deliberate indifference under Monell v. Department of Social Services, 436 U.S. 658 (1978). Cite Washington Post, August 19, 2026 (MacMillan, Schaffer, Harwell). Discovery: audit records for 24 months; leadership communications on misuse risk; public assurances; prior internal complaints; written audit policy if any.
7. Demand: specific dollar amount or demand for meaningful settlement negotiation; preservation of all records including the specific ${vendorName} query, audit logs, officer query history, BOLOs / MYOC-style alerts, and camera footage; response deadline of 30 days
8. First Amendment discovery (when Vector 5 applies): ALPR queries against the client's plate in the 90 days after public criticism; complete BOLO; communications directing officers to find stop pretexts; BOLO policy; prior civil-rights complaints involving the same supervisors
9. Notice that failure to respond will result in filing of a Section 1983 complaint in federal district court
10. Closing and signature block placeholder
11. CC line: Institute for Justice and other organizations counsel may wish to notify based on case facts (e.g., ACLU of Kansas when Lenexa-pattern First Amendment facts apply). Do not imply this tool is affiliated with or endorsed by any advocacy organization.
