...
const VENDORS = {
  flock: {
    ...
    accessAbuseFacts: [
      ...
      "Flock Safety spent years assuring cities and police departments that its cameras 'are not used to enforce traffic violations such as speeding, running red lights, or other moving violations.' Flock quietly removed that language from its materials after December 2, 2025, according to Streetsblog analysis. In December 2025, a Georgia motorcyclist received a traffic citation containing the text 'CAPTURED ON FLOCK CAMERA 31 MM 1 HOLDING PHONE IN LEFT HAND' — no traffic stop, no officer present, just a plate-reader image and a mailed citation (404 Media, December 2025; ticket later dropped). Speed-camera vendors are now feeding footage directly into Flock's cloud via Flock Wing License arrangements. Flock's own Speed Feedback Trailer combines plate recognition with speed data. The EFF named this pattern 'license plate reader mission creep' in March 2026. GadgetReview / Streetsblog / EFF, 2025–2026.",
      "Sequential Flock camera images can be used to estimate vehicle speed by calculating distance traveled between frames — a method Jalopnik has documented and analyzed. Georgia's OCGA 17-4-23 requires traffic offenses to occur in the presence of an officer, making camera-only citations legally contestable in that state. Cities that contracted with Flock based on explicit assurances that the system would not be used for traffic enforcement are now in contracts whose scope has expanded beyond what was represented at signing.",
    ...
    authFacts: [
      ...
      "The removal of Flock's 'not used to enforce traffic violations' language after December 2, 2025, combined with active speed-camera vendor integrations via Flock Wing License arrangements, means footage from Flock cameras is now being used for enforcement purposes that were explicitly excluded from the original contractual representations to cities and police departments. Cities that signed contracts based on the no-traffic-enforcement representation have a potential misrepresentation claim against Flock for expanding the system's use beyond what was disclosed at signing.",
    ],
    civilFacts: [
    ...
    sources: [
      ...
      "Streetsblog USA — Flock removed no-traffic-enforcement pledge after December 2, 2025 (July 30, 2026)",
      "GadgetReview — Flock traffic enforcement mission creep (August 2026)",
      "EFF — 'license plate reader mission creep' statement (March 2026): eff.org/deeplinks/2026/03/traffic-violation-license-plate-reader-mission-creep-already-here",
      "Jalopnik — sequential Flock image speed estimation analysis (2026)",
    ],
  },
