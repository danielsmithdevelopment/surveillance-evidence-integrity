...
- [Agent instructions](https://challengethefootage.com/AGENTS.md)
- [OpenAPI](https://challengethefootage.com/openapi.json)
- [llms.txt](https://challengethefootage.com/llms.txt)
...
**Not legal advice.** Attorney review required before filing.

Vendors: Flock Safety, Axon, Motorola Solutions (Vigilant), Genetec, Verkada, or custom.
